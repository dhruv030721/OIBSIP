...
function LoginForm() {
    return (
        <div className='font-poppins w-[60%] h-[50%] flex flex-col justify-around'>
            ...
            <button class="bg-orange-500 font-black text-white border border-red-500 border-b-4 overflow-hidden relative px-4 py-2 rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 group">
