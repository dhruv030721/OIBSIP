...
function Card({ img, logo, name, description, price }) {
  return (
    <div className='flex flex-col items-center justify-center bg-gray-500 rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-30 drop-shadow-white-xl shadow-2xl border-t-orange-500 border-b-orange-500 border-2 border-x-transparent pb-5 text-white hover:-translate-y-3 transition-all h-[500px]'>
      {/* Img */}
