...
function EditItemCard({ item, DeleteItem }) {

    return (
        <div className='text-white flex flex-col bg-dark-blue py-7 px-6 rounded-xl items-center space-y-3 shadow-xl'>
            ...
            <div className='flex items-center space-x-5'>
                ...
                <Link onClick={() => {
                    DeleteItem(item._id)
                }} className='bg-red-300 py-2 px-5 rounded-xl text-black hover:scale-110 transition-all'><FaTrashAlt /></Link>
            </div>
        </div>
    )
}
